...
public static class EndpointRouteBuilderExt
{
    ...
    /// Used for POST endpoints that creates a single item.
    /// </summary>
    public static RouteHandlerBuilder ProducesPost<T>(this RouteHandlerBuilder builder) =>
        builder
    ...
    /// <summary>
    /// Used for POST endpoints that stream sse.
    /// </summary>
    public static RouteHandlerBuilder ProducesPostStream(this RouteHandlerBuilder builder) =>
        builder
            .ProducesValidationProblem()
            .ProducesProblem(StatusCodes.Status500InternalServerError);
    ...
    /// Used for PUT endpoints that updates a single item.
    /// </summary>
    public static RouteHandlerBuilder ProducesPut<T>(this RouteHandlerBuilder builder) =>
        builder
            .Produces<T>(StatusCodes.Status204NoContent)
            .Produces(StatusCodes.Status404NotFound)
            .ProducesValidationProblem()
            .ProducesProblem(StatusCodes.Status500InternalServerError);
